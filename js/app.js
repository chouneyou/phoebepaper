...
// Scroll down Change photo percentage
  // Higher number = more zoom
let scaleAmount = 0.3;

function scrollZoom() {
  const images = document.querySelectorAll("[data-scroll-zoomout]");
  let scrollPosY = 0;
...
$(".nav-btn").on({
  mouseenter: function () {
      ...
      $(".hidden-info").css("visibility","visible");
  },
  mouseleave: function () {
      //stuff to do on mouse leave
      $(".hidden-info").css("visibility","hidden");
  }
});

$(".nav-btn-images").click(function() {
 
      $(".hidden-info-images").toggle();
